...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex text justify-center items-center bg-[#344151] flex-col gap-10">
      <div className="text-[#0398d4] font-mediumm text-2xl">Increment && Decrement</div>
